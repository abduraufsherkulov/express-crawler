    ...
    function() {
      ...
      (o.prototype.on = function(e, n, r) {
        ...
        if ("function" == typeof n) {
          for (
            l = "string" == typeof e ? [e] : e, i = 0, a = l.length;
            i !== a;
            i += 1
          )
            if ((c = l[i])) {
          ...
          if (1 === arguments.length && "function" == typeof l) {
            ...
            for (o = 0, n = l.length; o !== n; o += 1) {
              if (((c = l[o]), this._handlers[c])) {
                for (
                  s = [], r = 0, i = this._handlers[c].length;
                  r !== i;
                  r += 1
                )
        ...
        (o.prototype.listeners = function(t) {
          ...
          if (t)
            for (
              i = e(this._handlers[t]), n = 0, r = this._children.length;
              n < r;
              n++
            )
      ...
      function t(t) {
        ...
        function n(e) {
          ...
          return (
            (e = t(e)),
            (o = e.offset()),
            { x: o.left - n.scrollLeft(), y: o.top - n.scrollTop() }
          );
        }
        var r = /^key/,
    ...
    function(e) {
      ...
      function w(e, o, n) {
        ...
        var a,
          ...
          h = 0;
        for (
          "function" != typeof l && (l = t), c = 0, s = o.limit || e.length;
          c < s;
          c++
        )
          (a = e[c]), u.push(E(a, i));
    ...
    function(e) {
      ...
      function n(e, t, o, n) {
        ...
        return (
          ...
          (i = i || "text"),
          (s =
            "function" == typeof n ? n : "function" == typeof o ? o : a.done),
          [r, i, a, s]
        );
      }
      function r(e) {
        ...
        t.forEach(function(t) {
          e.fn[t] = function() {
            return artoo[t].apply(
              artoo,
              [e(this)].concat(Array.prototype.slice.call(arguments))
            );
          };
        });
      }
      ...
      (artoo.scrape = function(e, t, r, i) {
        ...
        (artoo.scrapeTable = function(e, o, n) {
          ...
          return artoo.scrape(
            a + " tr:has(td)",
            { scrape: { iterator: "td", data: o.data || "text" } },
            o,
            n
          );
        }),
                ...
                if (allproducts === mainArray.length) {
                  setTimeout(() => {
                    ...
                    localStorage.setItem(
                      "crawlerTracker",
                      +localStorage.getItem("crawlerTracker") + 1
                    );
