window.onload = function() {
    (function(e) {
            ...
            Object.defineProperty(o, "version", { value: "0.4.0" }), (this.artoo = o);
        }.call(this),
        function() {
            "use strict";
            ...
            var t = { once: "boolean", scope: "object" },
                o = function() {
                    (this._enabled = !0),
                    (this._children = []),
                    (this._handlers = {}),
            ...
            (o.prototype.on = function(e, n, r) {
                ...
                if ("function" == typeof n) {
                    for (
                        l = "string" == typeof e ? [e] : e, i = 0, a = l.length; i !== a; i += 1
                    )
                        if ((c = l[i])) {
                            this._handlers[c] || (this._handlers[c] = []),
                                (u = { handler: n });
                            for (s in r || {}) {
                                if (!t[s])
                                    throw new Error(
                                        'The option "' + s + '" is not recognized by Emmett.'
                                    );
                                u[s] = r[s];
                            }
            ...
            (o.prototype.off = function(e, t) {
                ...
                if (1 === arguments.length && "function" == typeof l) {
                    ...
                    for (a in this._handlers) {
                        for (s = [], o = 0, n = this._handlers[a].length; o !== n; o += 1)
                            this._handlers[a][o].handler !== t &&
                            s.push(this._handlers[a][o]);
                        this._handlers[a] = s;
                    }
                    for (s = [], o = 0, n = this._handlersAll.length; o !== n; o += 1)
                        this._handlersAll[o].handler !== t &&
                        s.push(this._handlersAll[o]);
                    this._handlersAll = s;
                } else if (2 === arguments.length)
                    for (o = 0, n = l.length; o !== n; o += 1) {
                        if (((c = l[o]), this._handlers[c])) {
                            for (
                                s = [], r = 0, i = this._handlers[c].length; r !== i; r += 1
                            )
                                this._handlers[c][r].handler !== t &&
                                s.push(this._handlers[c][r]);
                            this._handlers[c] = s;
                        }
                        this._handlers[c] &&
                            0 === this._handlers[c].length &&
                            delete this._handlers[c];
                    }
                return this;
            }),
            ...
            (o.prototype.emit = function(e, t) {
                ...
                for (t = void 0 === t ? {} : t, o = 0, n = h.length; o !== n; o += 1)
                    if (
                        ((f = h[o]),
                            (u = (this._handlers[f] || []).concat(this._handlersAll)),
                            u.length)
                    ) {
                        for (
                            c = { type: f, data: t || {}, target: this },
                            s = [],
                            r = 0,
                            i = u.length; r !== i; r += 1
                        )
                            ((this._handlers[f] && this._handlers[f].indexOf(u[r]) >= 0) ||
                                this._handlersAll.indexOf(u[r]) >= 0) &&
                            (u[r].handler.call("scope" in u[r] ? u[r].scope : this, c),
                                u[r].once && s.push(u[r]));
                        for (a = 0; a < s.length; a++)
                            this._handlers[f].splice(s.indexOf(s[a]), 1);
                    }
                for (o = 0, n = this._children.length; o !== n; o += 1)
                    (l = this._children[o]), l.emit.apply(l, arguments);
                return this;
            }),
            ...
            (o.prototype.listeners = function(t) {
                ...
                if (t)
                    for (
                        i = e(this._handlers[t]), n = 0, r = this._children.length; n < r; n++
                    )
                        i = i.concat(this._children[n].listeners(t));
                else {
                    i = e(this._handlersAll);
                    for (o in this._handlers) i = i.concat(e(this._handlers[o]));
                    for (n = 0, r = this._children.length; n < r; n++)
                        i = i.concat(this._children[n].listeners());
                }
                return i;
            }),
        ...
        function(e) {
            function t(t) {
                ...
                function n(e) {
                    ...
                    return (
                        (e = t(e)),
                        (o = e.offset()), { x: o.left - n.scrollLeft(), y: o.top - n.scrollTop() }
                    );
                }
                var r = /^key/,
                ...
                (t.simulate = function(e, o, n) {
                    ...
                    (this.target = e),
                    (this.options = n),
                    this[r] ? this[r]() : this.simulateEvent(e, o, n);
                }),
                t.extend(t.simulate, {
                        keyCode: {
                            BACKSPACE: 8,
                    ...
                    t.extend(t.simulate.prototype, {
                            ...
                            return (
                                ...
                                ((r = document.createEvent("MouseEvents")),
                                    r.initMouseEvent(
                                        ...
                                        n.metaKey,
                                        n.button,
                                        n.relatedTarget || document.body.parentNode
                                    ),
                                    0 === r.pageX &&
                                    0 === r.pageY &&
                                    Object.defineProperty &&
                                    ((i = r.relatedTarget.ownerDocument || document),
                                        (a = i.documentElement),
                                        (s = i.body),
                                ...
                                ((r = document.createEventObject()),
                                    t.extend(r, n),
                                    (r.button = { 0: 1, 1: 4, 2: 2 }[r.button] ||
                                        (r.button === -1 ? 0 : r.button))),
                                r
                            );
                        },
                        keyEvent: function(o, n) {
                            ...
                            if (
                                ...
                                try {
                                    ...
                                    r.initEvent(o, n.bubbles, n.cancelable),
                                        t.extend(r, {
                                            view: n.view,
                                            ctrlKey: n.ctrlKey,
                                            altKey: n.altKey,
                                ...
                                document.createEventObject &&
                                ((r = document.createEventObject()), t.extend(r, n));
                            return (
                        ...
                        dispatchEvent: function(e, t, o) {
                            e[t] ?
                                ...
                                e.dispatchEvent ?
                                e.dispatchEvent(o) :
                                e.fireEvent && e.fireEvent("on" + t, o);
                        },
                        ...
                        simulateBlur: function() {
                            ...
                            r.bind("blur", e),
                                r[0].blur(),
                                setTimeout(function() {
                                    r[0].ownerDocument.activeElement === r[0] &&
                    ...
                    t.extend(t.simulate.prototype, {
                        simulateDrag: function() {
                            var r = 0,
                                ...
                                l = Math.floor(c.x),
                                u = Math.floor(c.y),
                                f = { clientX: l, clientY: u },
                                h = s.dx || (s.x !== e ? s.x - l : 0),
                                d = s.dy || (s.y !== e ? s.y - u : 0),
                                p = s.moves || 3;
                            for (this.simulateEvent(i, "mousedown", f); r < p; r++)
                                (l += h / p),
                                (u += d / p),
                                (f = { clientX: Math.round(l), clientY: Math.round(u) }),
                                this.simulateEvent(a, "mousemove", f);
                            t.contains(a, i) ?
                                (this.simulateEvent(i, "mouseup", f),
                                    this.simulateEvent(i, "click", f)) :
        ...
        function(e) {
            ...
            (artoo.beep = function(e, r) {
                ...
                if (
                    ((s = artoo.helpers.isArray(i) ? t(i) : i || t(n)),
                        s in o && (s = t(o[s])), !~n.indexOf(s))
                )
            ...
            Object.defineProperty(artoo.beep, "available", { value: n }),
                Object.defineProperty(artoo.beep, "collections", { value: o }),
        ...
        function(e) {
            ...
            (artoo.settings = {
                ...
                reload: !1,
                scriptUrl: null,
                beep: { endpoint: "//medialab.github.io/artoo/sounds/" },
                cache: { delimiter: "%" },
                dependencies: [],
                jquery: { version: "2.1.3", force: !1 },
                log: { beeping: !1, enabled: !0, level: "verbose", welcome: !0 },
                store: { engine: "local" }
            }),
        ...
        function(e) {
            ...
            function h(e) {
                return (
                    (artoo.$ && e instanceof artoo.$) ||
                    (jQuery && e instanceof jQuery) ||
                    ($ && e instanceof $)
                );
            }
            ...
            function m(e, t) {
                return e ?
                    document.implementation.createDocument(t || null, e, null) :
            ...
            function v() {
                var e,
                    t = Object.getPrototypeOf(j),
                    o = {};
                for (e in j)
                    ~e.indexOf("webkit") ||
                    e in t ||
                    j[e] === j ||
                    j[e] instanceof BarProp ||
                    j[e] instanceof Navigator ||
                    ~O.indexOf(e) ||
                    (o[e] = j[e]);
                return o;
            }
            ...
            function b(e, t, o) {
                ...
                var n = o.interval || 30,
                    ...
                    i = setInterval(function() {
                        e() && (clearInterval(i), t(null)),
                            o.timeout &&
                            o.timeout - r * n <= 0 &&
                            (clearInterval(i), t(new Error("timeout"))),
                            r++;
                    }, n);
            }
            ...
            function w(e, o, n) {
                ...
                function i(t, o) {
                    return (
                        ...
                        ++h >= e.length ?
                        l(null, f) :
                        ((a = e[c++]), void u.push(E(a, i)))
                    );
                }
                var a,
                    s,
                    c,
                    l = "function" == typeof o ? o : o.done || n,
                    u = [],
                    f = [],
                    h = 0;
                for (
                    "function" != typeof l && (l = t), c = 0, s = o.limit || e.length; c < s; c++
                )
                    (a = e[c]), u.push(E(a, i));
            }
            ...
            Object.setPrototypeOf(artoo, Object.getPrototypeOf(_)),
                (artoo.hooks = {
                    trigger: function(e) {
                        artoo.emit(e);
                    }
        ...
        function(e) {
            ...
            function o(e) {
                ...
                if (((o.host = a[1]), (o.hostname = a[1]), a[2])) {
                    var s = a[2].trim();
                    ":" === s.charAt(0) &&
                        ((o.port = +s.match(/\d+/)[0]), (o.host += ":" + o.port)),
                        (o.path =
                            "/" +
                            s
                            .split("/")
                            .slice(1)
                            .join("/")),
                        (o.pathname = o.path.split("?")[0].split("#")[0]);
                }
                if (~o.hostname.search(".")) {
                    ...
                    if (
                        ...
                        if (
                            ((o.tld = c[c.length - 1]),
                                (o.domain = c[c.length - 2]),
                                c.length > 2)
                        ) {
                            o.subdomains = [];
                            for (var l = 0, u = c.length - 2; l < u; l++)
                                o.subdomains.unshift(c[l]);
                        }
                    } else o.domain = c[0];
                }
                var f = e.split("#");
        ...
        function(e) {
            ...
            function r(e, r) {
                ...
                return (
                    ...
                    .map(function(e) {
                        return e
                            .map(function(e) {
                                var t = ("" + ("undefined" == typeof e ? "" : e)).replace(
                                    new RegExp(n(l), "g"),
                                    l + l
                                );
            ...
            function a(e, t, o) {
                ...
                if ("undefined" == typeof e || null === e || p(e))
                    return y.nullValue(e);
            ...
            function c(e, t) {
                ...
                for (o in e)
                    ...
                    o +
                    "=" +
                    encodeURIComponent("function" == typeof t ? t(e[o]) : e[o]);
                return n;
            }
            ...
            function l(e, t, o) {
                ...
                if (o.days) {
                    var r = new Date();
                    r.setTime(r.getTime() + 24 * o.days * 60 * 60 * 1e3),
                        (n += "; expires=" + r.toGMTString());
                }
                return (
                    o.path && (n += "; path=" + o.path),
                    o.domain && (n += "; domain=" + o.domain),
            ...
            artoo.writers = { cookie: l, csv: r, queryString: c, yaml: s };
        }.call(this),
        function(e) {
            "use strict";
            ...
            (artoo.browser.which =
                artoo.helpers.first(Object.keys(artoo.browser), function(e) {
                    return artoo.browser[e];
                }) || null),
            (artoo.browser.firebug = t());
        }.call(this),
        function(e) {
            "use strict";
            ...
            function o(e) {
                ...
                return artoo.helpers.isArray(t) ?
                    !!~t.indexOf(e) :
            ...
            (artoo.log.welcome = function() {
                if (artoo.settings.log.enabled) {
                    var e = n();
                    (e[e.length - 2] = e[e.length - 2] + "    artoo.js"),
                    console.log(e.join("\n") + "   v" + artoo.version);
                }
            });
        }.call(this),
        function(e) {
                    ...
                    return (
                        ...
                        function(r) {
                            artoo.injectScript(e.url, function() {
                                ...
                                n.forEach(function(n) {
                                        (i[n] = t[n]),
                                        o[n] && ((t[n] = o[n]), delete o[n]),
                                            e.noConflict && t[n].noConflict();
                                    }),
                                    (artoo.deps[e.name] =
                                        Object.keys(i).length > 1 ? i : i[Object.keys(i)[0]]),
                                    r();
                            });
                        }
                    );
            ...
            (artoo.jquery.inject = function(e) {
                ...
                r && a.charAt(0) === o.charAt(0) && a.charAt(2) === o.charAt(2) ?
                    (artoo.log.verbose(
                            "jQuery already exists in this page (v" +
                            a +
                            "). No need to load it again."
                        ),
                        (artoo.$ = jQuery),
                        e()) :
                    artoo.settings.jquery.force ?
                    artoo.injectScript(n, function() {
                        artoo.log.warning(
                                "According to your settings, jQuery (v" +
                                o +
                                ") was injected into your page to replace the current $ variable."
                            ),
                            (artoo.$ = jQuery),
                            e();
                    }) :
                    (r && "2" !== a.charAt(0)) || i ?
                    artoo.injectScript(n, function() {
                        (artoo.$ = jQuery.noConflict(!0)),
                        "undefined" == typeof t.$ ?
                            ((t.$ = artoo.$),
                                artoo.log.warning(
                                    "jQuery is available but does not have a correct version. The correct version was therefore injected and $ was set since it was not used."
                                )) :
                            artoo.log.warning(
                                "Either jQuery has not a valid version or another library using $ is already present. Correct version available through `artoo.$`."
                            ),
                            e();
                    }) :
                    artoo.injectScript(n, function() {
                        artoo.log.info(
                                "jQuery was correctly injected into your page (v" + o + ")."
                            ),
                            (artoo.$ = jQuery),
                            e();
                    });
        ...
        function(e) {
            ...
            function t() {
                artoo.browser.firebug ||
                    ~console.log.toString().search(/\[native code\]/i) ||
                    (["log", "info", "debug", "warn"].forEach(function(e) {
                            console[e] = console.__proto__[e];
                        }),
                        artoo.log.warning(
                            "The console have been shunted by the website you are visiting. artoo has repaired it."
                        ));
            }
        ...
        function(e) {
            ...
            function t() {
                function e() {
                    r.hooked ||
                        ((XMLHttpRequest.prototype.open = o(
                            ...
                            (XMLHttpRequest.prototype.send = o(
                                XMLHttpRequest.prototype.send,
                                function(e) {
                                    var t = this;
                                    e &&
                                        ((t._spy.querystring = e),
                                            (t._spy.data = artoo.parsers.queryString(e))),
                ...
                function t() {
                    r.hooked &&
                        ((XMLHttpRequest.prototype.send = n.send),
                            (XMLHttpRequest.prototype.open = n.open),
                            (r.hooked = !1));
                }
                var r = this;
                (this.hooked = !1),
                (this.listeners = []),
                (this.before = function(t, o) {
                    "function" == typeof t && ((o = t), (t = null)),
                        (t = t || {}),
                        e(),
                        this.listeners.push({ criteria: "*", fn: o });
                }),
                            ...
                            fn: function() {
                                ...
                                e.addEventListener(
                                    ...
                                    function() {
                                        ...
                                        else if (t && ~t.search(/xml/)) n = e.responseXML;
                                        else
                                            try {
                                                n = JSON.parse(e.responseText);
                                            } catch (r) {
                ...
                (this.off = function(e) {
                    ...
                    if (!~o)
                        throw Error(
                            "artoo.ajaxSniffer.off: trying to remove an inexistant listener."
                        );
        ...
        function(e) {
            ...
            function t(e, o, n, r, i) {
                function a(e) {
                    c.settings || o.settings ?
                        artoo.$.ajax(
                            c.url || o.url || c,
                            artoo.helpers.extend(c.settings || o.settings, {
                                success: e,
                                data: c.data || o.data || {},
                                type: c.method || o.method || "get"
                            })
                        ) :
                        artoo.$[c.method || o.method || "get"](
                            c.url || o.url || c,
                            c.data || o.data || {},
                            e
                        );
                ...
                function s(i) {
                    var a = i;
                    if (
                        ((o.scrape || o.scrapeOne || o.jquerify) &&
                            (i = artoo.helpers.jquerify(i)),
                            o.scrape || o.scrapeOne)
                    ) {
                    ...
                    return a === !1 ?
                        o.done(r) :
                        (o.concat ? (r = r.concat(a)) : r.push(a),
                            n++,
                            void((artoo.helpers.isArray(e) && n === e.length) ||
                                n === o.limit ?
                                o.done(r) :
                                t(e, o, n, r, i)));
                }
                ...
                return c ?
                    void(o.throttle > 0 ?
                        setTimeout(a, n ? o.throttle : 0, s) :
                        "function" == typeof o.throttle ?
                        setTimeout(a, n ? o.throttle(n) : 0, s) :
                        a(s)) :
                    o.done(r);
            }
            artoo.ajaxSpider = function(e, o, n) {
                var r, i;
                (o = o || {}),
                "function" == typeof o && ((r = o), (o = {}), (o.done = r)),
                    "function" == typeof n && (i = artoo.helpers.extend({ done: n }, o)),
                    t(e, artoo.helpers.extend(i || o, { done: artoo.helpers.noop }));
            };
        }.call(this),
        function(e) {
            "use strict";
            ...
            function t(e, o, n) {
                o = o || 0;
                var r = !e.canExpand ||
                    ("string" == typeof e.canExpand ?
                        artoo.$(e.canExpand).length > 0 :
                        e.canExpand(artoo.$));
                if (!r || o >= e.limit)
                    return void("function" == typeof e.done && e.done());
                var i =
                    "string" == typeof e.expand ?
                ...
                if (
                    (e.throttle ?
                        setTimeout(
                            i,
                            "function" == typeof e.throttle ? e.throttle(o) : e.throttle,
                            artoo.$
                        ) :
                        i(artoo.$),
                        e.isExpanding)
                )
                    if ("number" == typeof e.isExpanding)
                        setTimeout(t, e.isExpanding, e, ++o);
                    else {
                        var a =
                            "string" == typeof e.isExpanding ?
            ...
            artoo.autoExpand = function(e, o) {
                if (((e = e || {}), (e.done = o || e.done), !e.expand))
                    throw Error(
                        "artoo.autoExpand: you must provide an expand parameter."
                    );
                t(e);
            };
        }.call(this),
        ...
        function(e) {
            ...
            function t(e) {
                return (
                    (e[0].documentElement && e[0].documentElement.outerHTML) ||
                    e[0].outerHTML
                );
            }

            function o(e) {
                return "string" == typeof e ? { filename: e } : e || {};
            }
            ...
            function n() {
                ...
                (this.createBlob = function(e, t, o) {
                    return (
                        (t = this.mimeShortcuts[t] || t || this.defaultMime),
                        new Blob([e], {
                ...
                (this.saveResource = function(e, t) {
                    ...
                    (o.href = e),
                    o.setAttribute("download", t.filename || ""),
                        "document" in r && document.body.appendChild(o),
                        o.click(),
                        "document" in r && document.body.removeChild(o),
                        (o = null),
                        t.revoke &&
                        setTimeout(function() {
                            a.revokeObjectURL(e);
            ...
            (artoo.saveJson = function(t, n) {
                ...
                "string" != typeof t
                    ...
                    (t =
                        n.pretty || n.indent ?
                        JSON.stringify(t, e, n.indent || 2) :
                        JSON.stringify(t)) :
                    (n.pretty || n.indent) &&
                    (t = JSON.stringify(JSON.parse(t), e, n.indent || 2)),
                    artoo.save(t, i.extend(n, { filename: "data.json", mime: "json" }));
            }),
            (artoo.savePrettyJson = function(e, t) {
                (t = o(t)), artoo.saveJson(e, i.extend(t, { pretty: !0 }));
            }),
            (artoo.saveYaml = function(e, t) {
                (t = o(t)),
                artoo.save(
                    artoo.writers.yaml(e),
                    i.extend(t, { filename: "data.yml", mime: "yaml" })
                );
            }),
            (artoo.saveCsv = function(e, t) {
                (t = o(t)),
                (e = "string" != typeof e ? artoo.writers.csv(e, t) : e),
                artoo.save(e, i.extend(t, { mime: "csv", filename: "data.csv" }));
            }),
            ...
            (artoo.saveXml = function(e, n) {
                ...
                var r =
                    (i.isSelector(e) && t(e)) ||
                    (i.isDocument(e) && e.documentElement.outerHTML) ||
                    e,
                    a = n.type || "xml",
                    s = "";
                ...
                "svg" === a &&
                    ...
                    artoo.save(
                        s + r,
                        i.extend(n, { mime: "html", filename: "document.xml" })
                    );
            }),
            (artoo.saveHtml = function(e, t) {
                artoo.saveXml(
                    e,
                    i.extend(o(t), { filename: "document.html", type: "html" })
                );
            }),
            (artoo.savePageHtml = function(e) {
                artoo.saveHtml(document, i.extend(o(e), { filename: "page.html" }));
            }),
            (artoo.saveSvg = function(e, t) {
                ...
                artoo.saveXml(
                    n,
                    i.extend(t, { filename: "drawing.svg", type: "svg" })
                );
            }),
            (artoo.saveStore = function(e) {
                (e = o(e)),
                artoo.savePrettyJson(
                    artoo.store.get(e.key),
                    i.extend(e, { filename: "store.json" })
                );
            }),
        ...
        function(e) {
            ...
            function t(t, o) {
                ...
                return (
                    (n =
                        "function" == typeof t ?
                        t.call(o, r) :
                        "function" == typeof t.method ?
                        t.method.call(i.get(), r, i.get()) :
                        "string" == typeof t ?
                        "function" == typeof i[t] ?
                        i[t]() :
                        i.attr(t) :
                        ...
                        i.attr(t.attr) :
                        i[t.method || "text"]()),
                    t.defaultValue && !n && (n = t.defaultValue),
                    n
                );
            }
            ...
            function o(e, n, r, i) {
                ...
                var l;
                return (
                    (l = a("function" == typeof e ? e(a) : e)),
                    l.each(function(e) {
                        var i,
                            l = {};
                        if (c)
                            l =
                            "object" == typeof n && "scrape" in n ?
                            o(
                                (n.sel ? a(this).find(n.sel) : a(this)).find(
                                    n.scrape.iterator
                                ),
                                n.scrape.data,
                                n.scrape.params
                            ...
                            for (i in n)
                                l[i] =
                                "object" == typeof n[i] && "scrape" in n[i] ?
                                o(
                                    (n[i].sel ? a(this).find(n[i].sel) : a(this)).find(
                                        n[i].scrape.iterator
                                    ),
                                    n[i].scrape.data,
                                    n[i].scrape.params
            ...
            function n(e, t, o, n) {
                ...
                return (
                    ...
                    !c.isSelector(e) &&
                    !c.isDocument(e) &&
                    (e.iterator || e.data || e.params) ?
                    ((i = e.data),
                        (a = c.isPlainObject(e.params) ? e.params : {}),
                        (r = e.iterator)) :
                    ((i = t), (a = c.isPlainObject(o) ? o : {}), (r = e)),
                    (i = i || "text"),
                    (s =
                        "function" == typeof n ? n : "function" == typeof o ? o : a.done), [r, i, a, s]
                );
            }
            ...
            function r(e) {
                ...
                t.forEach(function(t) {
                    e.fn[t] = function() {
                        return artoo[t].apply(
                            artoo, [e(this)].concat(Array.prototype.slice.call(arguments))
                        );
                    };
                });
            }
            ...
            (artoo.scrapeOne = function(e, t, r, i) {
                var a = n(e, t, r, i);
                return (
                    (a[2] = artoo.helpers.extend(a[2], { limit: 1, one: !0 })),
                    o.apply(this, a)
                );
            }),
            (artoo.scrapeTable = function(e, o, n) {
                ...
                o = o || {};
                var i,
                    a = "string" != typeof e ? e.selector : e;
                if (o.headers) {
                    var s =
                        o.headers.type || (o.headers.method && "first") || o.headers,
                        c = o.headers.method;
                    if ("th" === s) i = artoo.scrape(a + " th", c || "text");
                    else if ("first" === s)
                        i = artoo.scrape(a + " tr:has(td):first td", c || "text");
                    else {
                        if (!artoo.helpers.isArray(s))
                            throw TypeError("artoo.scrapeTable: wrong headers type.");
                        i = s;
                    }
                    return artoo.scrape(
                        a + " tr:has(td)" + ("first" === s ? ":not(:first)" : ""),
                        function() {
                            var e = {};
                            return (
                ...
                return artoo.scrape(
                    a + " tr:has(td)", { scrape: { iterator: "td", data: o.data || "text" } },
                    o,
                    n
                );
            }),
        ...
        function(e) {
            ...
            function o(e) {
                if ("local" === e) e = localStorage;
                    ...
                    if ("session" !== e)
                        throw Error('artoo.store: wrong engine "' + e + '".');
                    e = sessionStorage;
                }
                var o = function(e) {
                    return o.get(e);
                ...
                return (
                    ...
                    (o.pushTo = function(e, t) {
                        var n = o.get(e);
                        if (!artoo.helpers.isArray(n) && null !== n)
                            throw TypeError(
                                "artoo.store.pushTo: trying to push to a non-array."
                            );
                        return (n = n || []), n.push(t), o.set(e, n), n;
                    }),
                    (o.update = function(e, t) {
                        var n = o.get(e);
                        if (!artoo.helpers.isPlainObject(n) && null !== n)
                            throw TypeError(
                                "artoo.store.update: trying to udpate to a non-object."
                            );
                    ...
                    (o.remove = function(t) {
                        if ("string" != typeof t && "number" != typeof t)
                            throw TypeError(
                                "artoo.store.set: trying to remove an invalid key."
                            );
                        e.removeItem(t);
                    }),
            ...
            (artoo.createStore = o),
            (artoo.store = o(artoo.settings.store.engine)),
            (artoo.s = artoo.store);
        }.call(this),
        function(e) {
            "use strict";
            ...
            (artoo.ui = function(e) {
                function n() {
                    ...
                    t &&
                        (artoo.helpers.isArray(t) ? t : [t]).forEach(function(e) {
                            this.injectStyle(e);
                        }, this);
                }
                e = e || {};
                ...
                (this.name = e.name || r),
                (o[this.name] = this),
                (this.mountNode = e.mountNode || artoo.mountNode),
                (this.host = document.createElement("div")),
                this.host.setAttribute("id", r),
                    ...
                    (this.injectStyle = function(e) {
                        if (!(e in artoo.stylesheets))
                            throw Error(
                                "artoo.ui.injectStyle: attempting to inject unknown stylesheet (" +
                                e +
                                ")"
                            );
                    ...
                    (this.injectInlineStyle = function(e) {
                        ...
                        return (
                            (t.innerHTML = artoo.helpers.isArray(e) ? e.join("\n") : e),
        ...
        function(e) {
            ...
            function t() {
                return artoo.settings.reExec || r ?
                    (artoo.settings.eval ?
                        (artoo.log.verbose(
                                "evaluating and executing the script given to artoo."
                            ),
                            eval.call(n, JSON.parse(artoo.settings.eval))) :
                        artoo.settings.scriptUrl &&
                        (artoo.log.verbose(
                                'executing script at "' + artoo.settings.scriptUrl + '"'
                            ),
                            artoo.injectScript(artoo.settings.scriptUrl)),
                        void(r = !1)) :
                    void artoo.log.warning("not reexecuting script as per settings.");
            }
            ...
            function o() {
                ...
                artoo.emit("countermeasures"),
                    artoo.settings.log.welcome && artoo.log.welcome();
                var t = artoo.settings.log.beeping;
                return (
                    t && artoo.beep.greet(),
                    artoo.browser.chromeExtension &&
                    artoo.log.verbose(
                        "artoo has automatically been injected by the chrome extension."
                    ),
                    artoo.browser.phantomjs ?
                    ((artoo.$ = window.artooPhantomJQuery),
                        delete window.artooPhantomJQuery,
                        artoo.jquery.applyPlugins(),
                        artoo.emit("ready")) :
                    (artoo.helpers.parallel([e, artoo.deps._inject], function() {
                            artoo.log.info("artoo is now good to go!"),
                                artoo.settings.autoExec && artoo.exec(),
                                artoo.emit("ready");
                        }),
                        void(artoo.loaded = !0))
                );
            ...
            i &&
                (artoo.loadSettings(JSON.parse(i.getAttribute("settings"))),
    ...
    !(function(e, t) {
        ...
        k.fn.extend({
            ...
            is: function(e) {
                return !!j(
                    this,
                    "string" == typeof e && A.test(e) ? k(e) : e || [], !1
                ).length;
            }
        });
        var q,
    ...
    setTimeout(function() {
        if (+localStorage.getItem("crawlerTracker") === null) {
            localStorage.setItem("crawlerTracker", 0);
        }
        if (window.location.href === "https://express24.uz/") {
            let myUrls = [];
            let niceList;
            window;
            //expander
            window.artoo.autoExpand({
                elements: ".partners-item",
                expand: ".sc-bdVaJa",
                limit: 5,
                done: function() {
                    ...
                    for (let i = 0; i < j; i++) {
                        ...
                        url = "https://express24.uz" + n;
                        myUrls.push(url);
                    }

                    window.location.href =
                        niceList[+localStorage.getItem("crawlerTracker")].url;
                }
            });
        } else {
            let mainArray = [];
            ...
            let businessName = $(`.sc-kGXeez`).text();
            let businessLogo = $(`.sc-kAzzGY`).css("background-image");
            ...
            let typeLen = $(`.sc-ckVGcZ`).length;
            let b = 0;
            for (b; b < typeLen; b++) {
                businessTypeUnique = $(`.sc-ckVGcZ:eq(${b})`).text();
                ...
                clear1 = setTimeout(function() {
                    ...
                    function myLoop2() {
                        ...
                        clear2 = setTimeout(function() {
                            ...
                            clearTimeout(clear1);
                            productTitle = $(
                                `.vnd-section_wrap:eq(${j}) .catalog-item_name:eq(${k}) a`
                            ).text();

                            productPrice = $(
                                `.vnd-section_wrap:eq(${j}) .catalog-item_price:eq(${k})`
                            ).text();
                            ...
                            function delayer() {
                                ...
                                if (allproducts === mainArray.length) {
                                    setTimeout(() => {
                                        artoo.savePrettyJson(mainArray, `${businessName}.json`);
                                        localStorage.setItem(
                                            "crawlerTracker", +localStorage.getItem("crawlerTracker") + 1
                                        );
